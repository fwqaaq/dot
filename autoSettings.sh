...
read -p "\e[32mDo you want to install nvm to manage node config? Please intput (y/n)\e[0m" answer
...
read -p "\e[32mDo you want to install tmux config? Please intput (y/n)\e[0m" answer
